...
def inserir_usuario():
    ...
    try:
        cursor.execute("INSERT INTO cliente (id, nome, email, senha, cnh) VALUES (seq_id_gerador.NEXTVAL, :1, :2, :3, :4)",
...
def verificar_usuario():
    ...
    try:
        cursor.execute("SELECT * FROM cliente WHERE email = :1 AND senha = :2",
                       (cnh, senha))
